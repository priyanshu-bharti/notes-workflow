...
type: "DSA"
topic: "Arrays"
problem: "Move all 0's to the end of an array in-place while maintaining the relative order of non-zero elements."
difficulty: "Easy"
description: "Rearrange elements of an array so that all 0s are moved to the end without changing the order of non-zero elements. Must be done in-place."
